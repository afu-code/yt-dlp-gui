...
[功能特性](#-功能特性) • [安装](#-安装) • [使用](#-使用) • [截图](#-截图) • [贡献](#-贡献)
...
- 🎨 **现代化界面** - 简洁直观的界面，支持深色主题
- 🌍 **多语言支持** - 支持英语、简体中文、繁体中文、日语和韩语
- 📑 **分类设置** - 标签页式界面，便于配置：
  - **通用**：格式选择、质量设置、输出模板
  - **网络**：代理配置、Cookie、速率限制
  - **过滤器**：播放列表过滤、日期范围、文件大小限制
  - **后处理**：音频提取、视频转换、元数据嵌入
  - **高级**：自定义 CLI 参数，实时命令预览
...
- 或使用 [Chocolatey](https://chocolatey.org/)：`choco install ffmpeg`
...
- [yt-dlp](https://github.com/yt-dlp/yt-dlp) - 本 GUI 基于的强大命令行工具
- 本项目的所有贡献者和用户
